...
<body>
    <div class="container">
        ...
        <form action="" method="post">
            ...
            <div class="form-outline">
                <input name="nom_du_corps_medical" type="text" id="nom_du_corps_medical" class="form-control" />
                <label class="form-label" for="nom_du_corps_medical">nom du corps medical</label>
            </div>
            <div class="form-outline">
                <input name="email_professionnel" type="text" id="email_professionnel" class="form-control" />
            ...
            <div class="form-outline">
                <input name="pays" type="texte" id="pays" class="form-control" />
                <label class="form-label" for="pays">pays </label>
            </div>
            <div class="form-outline">

                <input name="ville" type="text" id="ville" class="form-control" />
                <label class="from-label" for="ville">ville</label>
            </div>

            <input style="float:right;" type="submit" class="btn btn-black" value="add client ">
